...
class RN4_reddito_imponibile (Variable):
    value_type = float
    entity = Persona
    ...
    def formula(person, period, parameters):
        ...
        RN1_reddito_complessivo = person('RN1_reddito_complessivo',period) + person('RN1_credito_per_fondi_comuni',period) - person('RN1_perdite_compensabili_con_crediti_per_fondi_comuni',period) - person('RN2_deduzione_abitazione_principale',period) - person('RN3_oneri_deducibili_totali',period)
        ...
        RN1_reddito_complessivo = where (possiede_diritto_agevolazione_ACE,(RN1_reddito_complessivo + RS37_importo_del_rendimento_nozionale_di_spettanza_dell_imprenditore),RN1_reddito_complessivo)
        ...
        RN1_reddito_complessivo = where (possiede_diritto_agevolazione_per_attivita_sportive,(RN1_reddito_complessivo + RL22_compensi_con_ritenuta_a_titolo_di_imposta),RN1_reddito_complessivo)
        return where (RN1_reddito_complessivo >= 0, RN1_reddito_complessivo, np.array(0))
